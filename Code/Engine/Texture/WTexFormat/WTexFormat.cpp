...
void WTexFormat::WriteTextureHeader(WStreamWriter& inout_stream) const
{
  WUInt8 uiFileFormatVersion = 2;
...
void WTexFormat::WriteRenderTargetHeader(WStreamWriter& inout_stream) const
{
  WUInt8 uiFileFormatVersion = 5;
  inout_stream << uiFileFormatVersion;
...
void WTexFormat::ReadHeader(WStreamReader& inout_stream)
{
  WUInt8 uiFileFormatVersion = 0;
  inout_stream >> uiFileFormatVersion;
