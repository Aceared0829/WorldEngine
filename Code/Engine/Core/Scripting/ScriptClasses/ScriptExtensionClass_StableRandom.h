...
class W_CORE_DLL WScriptExtensionClass_StableRandom
{
public:
  ...
  static int IntMinMax(int& inout_iPosition, int iMinValue, int iMaxValue, WUInt32 uiSeed);
  ...
  static float FloatZeroToOne(int& inout_iPosition, WUInt32 uiSeed);
  ...
  static float FloatMinMax(int& inout_iPosition, float fMinValue, float fMaxValue, WUInt32 uiSeed);
  ...
  static WVec3 Vec3MinMax(int& inout_iPosition, const WVec3& vMinValue, const WVec3& vMaxValue, WUInt32 uiSeed);
};

W_DECLARE_REFLECTABLE_TYPE(W_CORE_DLL, WScriptExtensionClass_StableRandom);
