...
class WVulkanInitInterface
{
public:
  virtual ~WVulkanInitInterface() = default;

  /// Creates the Vulkan instance using platform-specific requirements.
  ...
  /// Returns the physical device to use.
  ...
  /// Creates the Vulkan device using platform-specific requirements.
  ...
  /// Extends the instance extensions required.
  /// Used by XR_KHR_vulkan_enable (v1) to add required instance extensions.
  virtual void ExtendInstanceExtensions(const WDynamicArray<vk::ExtensionProperties>& availableExtensions, WDynamicArray<WString>& ref_extensions) {}

  /// Extends the device extensions required.
  /// Used by XR_KHR_vulkan_enable (v1) to add required device extensions.
  virtual void ExtendDeviceExtensions(const WDynamicArray<vk::ExtensionProperties>& availableExtensions, WDynamicArray<WString>& ref_extensions) {}
};
