...
/// WStringBuilder is a class that is meant for creating and modifying strings.
///
/// It is not meant to store strings for a longer duration.
/// Each WStringBuilder uses an WHybridArray to allocate a large buffer on the stack, such that string manipulations
/// are possible without memory allocations, unless the string is too large.
/// No sharing of data happens between WStringBuilder instances, as it is expected that they will be modified anyway.
...
/// a second WStringBuilder, and iterate over the first while rebuilding the desired result in the second.
/// Once a string is built and should only be stored for read access, it should be stored in an WString instance.
class W_FOUNDATION_DLL WStringBuilder : public WStringBase<WStringBuilder>
{
public:
  /// Initializes the string to be empty. No data is allocated, but the WStringBuilder ALWAYS creates an array on the stack.
  WStringBuilder(WAllocator* pAllocator = WFoundation::GetDefaultAllocator()); // [tested]

  /// Copies the given string into this one.
  WStringBuilder(const WStringBuilder& rhs); // [tested]

  /// Moves the given string into this one.
  WStringBuilder(WStringBuilder&& rhs) noexcept;

  /// Copies the given string into this one.
  template <WUInt16 Size>
  WStringBuilder(const WHybridStringBase<Size>& rhs)
    : m_Data(rhs.m_Data)
  {
  }
  ...
  WStringBuilder(const WHybridString<Size, A>& rhs)
    : m_Data(rhs.m_Data)
  {
  }
  ...
  /// Moves the given string into this one.
  template <WUInt16 Size>
  WStringBuilder(WHybridStringBase<Size>&& rhs)
  ...
  /// Moves the given string into this one.
  template <WUInt16 Size, typename A>
  WStringBuilder(WHybridString<Size, A>&& rhs)
    : m_Data(std::move(rhs.m_Data))
  {
  }

  /// Constructor that appends all the given strings.
  WStringBuilder(WStringView sData1, WStringView sData2, WStringView sData3 = {}, WStringView sData4 = {},
    WStringView sData5 = {}, WStringView sData6 = {}); // [tested]

                                                         /// Copies the given Utf8 string into this one.
  /* implicit */ WStringBuilder(const char* szUTF8, WAllocator* pAllocator = WFoundation::GetDefaultAllocator()); // [tested]

                                                                                                                     /// Copies the given wchar_t string into this one.
  /* implicit */ WStringBuilder(const wchar_t* pWChar, WAllocator* pAllocator = WFoundation::GetDefaultAllocator()); // [tested]

                                                                                                                        /// Copies the given substring into this one. The WStringView might actually be a substring of this very string.
  /* implicit */ WStringBuilder(WStringView rhs, WAllocator* pAllocator = WFoundation::GetDefaultAllocator()); // [tested]

  /// Copies the given string into this one.
  void operator=(const WStringBuilder& rhs); // [tested]

  /// Moves the given string into this one.
  void operator=(WStringBuilder&& rhs) noexcept;
  ...
  /// Copies the given substring into this one. The WStringView might actually be a substring of this very string.
  void operator=(WStringView rhs); // [tested]
  ...
  /// Copies the given string into this one.
  template <WUInt16 Size, typename A>
  void operator=(const WHybridString<Size, A>& rhs)
  {
    m_Data = rhs.m_Data;
  }
  ...
  /// Moves the given string into this one.
  template <WUInt16 Size, typename A>
  void operator=(WHybridString<Size, A>&& rhs) noexcept
  {
    m_Data = std::move(rhs.m_Data);
  }
  ...
  void ChangeCharacter(iterator& ref_it, WUInt32 uiCharacter); // [tested]

  /// Sets the string to the given string.
  void Set(WStringView sData1); // [tested]
  /// Sets the string by concatenating all given strings.
  void Set(WStringView sData1, WStringView sData2); // [tested]
  /// Sets the string by concatenating all given strings.
  void Set(WStringView sData1, WStringView sData2, WStringView sData3); // [tested]
  /// Sets the string by concatenating all given strings.
  void Set(WStringView sData1, WStringView sData2, WStringView sData3, WStringView sData4); // [tested]
  /// Sets the string by concatenating all given strings.
  void Set(WStringView sData1, WStringView sData2, WStringView sData3, WStringView sData4, WStringView sData5, WStringView sData6 = {}); // [tested]

  /// Sets several path pieces. Makes sure they are always properly separated by a slash.
  void SetPath(WStringView sData1, WStringView sData2, WStringView sData3 = {}, WStringView sData4 = {});
  ...
  void SetSubString_ElementCount(const char* pStart, WUInt32 uiElementCount);

  /// Copies the string starting at \a pStart with a length of \a uiCharacterCount characters.
  void SetSubString_CharacterCount(const char* pStart, WUInt32 uiCharacterCount);

  /// Appends a single Utf32 character.
  void Append(WUInt32 uiChar); // [tested]
  ...
  void Append(WStringView sData1); // [tested]
  /// Appends all the given strings to the back of this string in one operation.
  void Append(WStringView sData1, WStringView sData2); // [tested]
  /// Appends all the given strings to the back of this string in one operation.
  void Append(WStringView sData1, WStringView sData2, WStringView sData3); // [tested]
  /// Appends all the given strings to the back of this string in one operation.
  void Append(WStringView sData1, WStringView sData2, WStringView sData3, WStringView sData4); // [tested]
  /// Appends all the given strings to the back of this string in one operation.
  void Append(WStringView sData1, WStringView sData2, WStringView sData3, WStringView sData4, WStringView sData5, WStringView sData6 = {}); // [tested]

  /// Prepends a single Utf32 character.
  void Prepend(WUInt32 uiChar); // [tested]
  ...
  /// Prepends all the given strings to the front of this string in one operation.
  void Prepend(WStringView sData1, WStringView sData2 = {}, WStringView sData3 = {}, WStringView sData4 = {},
    WStringView sData5 = {}, WStringView sData6 = {}); // [tested]
  ...
  /// Replaces this with a formatted string. Uses '{}' formatting placeholders, see WFormatString for details.
  void SetFormat(const WFormatString& string); // [tested]

  /// Replaces this with a formatted string. Uses '{}' formatting placeholders, see WFormatString for details.
  template <typename... ARGS>
  void SetFormat(const char* szFormat, ARGS&&... args) // [tested]
  {
    SetFormat(WFormatStringImpl<ARGS...>(szFormat, std::forward<ARGS>(args)...));
  }

  /// Appends a formatted string. Uses '{}' formatting placeholders, see WFormatString for details.
  void AppendFormat(const WFormatString& string); // [tested]

  /// Appends a formatted string. Uses '{}' formatting placeholders, see WFormatString for details.
  template <typename... ARGS>
  void AppendFormat(const char* szFormat, ARGS&&... args) // [tested]
  {
    AppendFormat(WFormatStringImpl<ARGS...>(szFormat, std::forward<ARGS>(args)...));
  }

  /// Prepends a formatted string. Uses '{}' formatting placeholders, see WFormatString for details.
  void PrependFormat(const WFormatString& string); // [tested]

  /// Prepends a formatted string. Uses '{}' formatting placeholders, see WFormatString for details.
  template <typename... ARGS>
  void PrependFormat(const char* szFormat, ARGS&&... args) // [tested]
  {
    PrependFormat(WFormatStringImpl<ARGS...>(szFormat, std::forward<ARGS>(args)...));
  }
  ...
  void Reserve(WUInt32 uiNumElements); // [tested]


  /// Replaces the string that starts at szStartPos and ends at szEndPos with the string szReplaceWith.
  void ReplaceSubString(const char* szStartPos, const char* szEndPos, WStringView sReplaceWith); // [tested]

  /// A wrapper around ReplaceSubString. Will insert the given string at szInsertAtPos.
  void Insert(const char* szInsertAtPos, WStringView sTextToInsert); // [tested]
  ...
  const char* ReplaceFirst(WStringView sSearchFor, WStringView sReplacement, const char* szStartSearchAt = nullptr); // [tested]

  /// Case-insensitive version of ReplaceFirst.
  const char* ReplaceFirst_NoCase(WStringView sSearchFor, WStringView sReplacement, const char* szStartSearchAt = nullptr); // [tested]
  ...
  const char* ReplaceLast(WStringView sSearchFor, WStringView sReplacement, const char* szStartSearchAt = nullptr); // [tested]

  /// Case-insensitive version of ReplaceLast.
  const char* ReplaceLast_NoCase(WStringView sSearchFor, WStringView sReplacement, const char* szStartSearchAt = nullptr); // [tested]

  /// Replaces all occurrences of szSearchFor by szReplacement. Returns the number of replacements.
  WUInt32 ReplaceAll(WStringView sSearchFor, WStringView sReplacement); // [tested]

  /// Case-insensitive version of ReplaceAll.
  WUInt32 ReplaceAll_NoCase(WStringView sSearchFor, WStringView sReplacement); // [tested]
  ...
  const char* ReplaceWholeWord(const char* szSearchFor, WStringView sReplaceWith, WStringUtils::W_CHARACTER_FILTER isDelimiterCB); // [tested]

  /// Case-insensitive version of ReplaceWholeWord.
  ///
  /// Returns the start position of where the word was replaced or nullptr if nothing got replaced.
  const char* ReplaceWholeWord_NoCase(const char* szSearchFor, WStringView sReplaceWith, WStringUtils::W_CHARACTER_FILTER isDelimiterCB); // [tested]
  ...
  WUInt32 ReplaceWholeWordAll(const char* szSearchFor, WStringView sReplaceWith, WStringUtils::W_CHARACTER_FILTER isDelimiterCB); // [tested]

  /// Case-insensitive version of ReplaceWholeWordAll.
  ///
  /// Returns how many words got replaced.
  WUInt32 ReplaceWholeWordAll_NoCase(const char* szSearchFor, WStringView sReplaceWith, WStringUtils::W_CHARACTER_FILTER isDelimiterCB); // [tested]
  ...
  void PathParentDirectory(WUInt32 uiLevelsUp = 1); // [tested]

  /// Appends several path pieces. Makes sure they are always properly separated by a slash.
  void AppendPath(WStringView sPath1, WStringView sPath2 = {}, WStringView sPath3 = {}, WStringView sPath4 = {}); // [tested]
  ...
  void AppendWithSeparator(WStringView sSeparator, WStringView sText1, WStringView sText2 = WStringView(), WStringView sText3 = WStringView(), WStringView sText4 = WStringView(), WStringView sText5 = WStringView(), WStringView sText6 = WStringView());

  /// Changes the file name part of the path, keeps the extension intact (if there is any).
  void ChangeFileName(WStringView sNewFileName); // [tested]

  /// Changes the file name and the extension part of the path.
  void ChangeFileNameAndExtension(WStringView sNewFileNameWithExtension); // [tested]
  ...
  void ChangeFileExtension(WStringView sNewExtension, bool bFullExtension = false); // [tested]
  ...
  WResult MakeRelativeTo(WStringView sAbsolutePathToMakeThisRelativeTo); // [tested]
  ...
  /// Removes C-style line comments (//) and block comments (/* */) from the string in-place.
  ///
  ...
  /// Copies the given substring into this one. The WStringView might actually be a substring of this very string.
  /* implicit */ WStringBuilder(const std::string_view& rhs, WAllocator* pAllocator = WFoundation::GetDefaultAllocator());

  /// Copies the given substring into this one. The WStringView might actually be a substring of this very string.
  /* implicit */ WStringBuilder(const std::string& rhs, WAllocator* pAllocator = WFoundation::GetDefaultAllocator());
...
private:
  ...
  void ChangeCharacterNonASCII(iterator& it, WUInt32 uiCharacter);
  void AppendTerminator();

  // needed for better copy construction
  template <WUInt16 T>
  friend struct WHybridStringBase;

  friend WStreamReader;

  WHybridArray<char, 128> m_Data;
};
