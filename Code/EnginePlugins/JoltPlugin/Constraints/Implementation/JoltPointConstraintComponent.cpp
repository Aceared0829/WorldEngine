...
// clang-format off
W_BEGIN_COMPONENT_TYPE(WJoltPointConstraintComponent, 1, WComponentMode::Static)
{
}
W_END_DYNAMIC_REFLECTED_TYPE;
// clang-format on

WJoltPointConstraintComponent::WJoltPointConstraintComponent() = default;
WJoltPointConstraintComponent::~WJoltPointConstraintComponent() = default;

void WJoltPointConstraintComponent::SerializeComponent(WWorldWriter& inout_stream) const
{
...
void WJoltPointConstraintComponent::DeserializeComponent(WWorldReader& inout_stream)
{
...
void WJoltPointConstraintComponent::ApplySettings()
{
  SUPER::ApplySettings();
}

void WJoltPointConstraintComponent::CreateContstraintType(JPH::Body* pBody0, JPH::Body* pBody1)
{
...
bool WJoltPointConstraintComponent::ExceededBreakingPoint()
{
...
W_STATICLINK_FILE(JoltPlugin, JoltPlugin_Constraints_Implementation_JoltPointConstraintComponent);
