...
class WSoundEventAssetDocumentManager : public WAssetDocumentManager
{
  W_ADD_DYNAMIC_REFLECTION(WSoundEventAssetDocumentManager, WAssetDocumentManager);

public:
  WSoundEventAssetDocumentManager();
  ~WSoundEventAssetDocumentManager();
