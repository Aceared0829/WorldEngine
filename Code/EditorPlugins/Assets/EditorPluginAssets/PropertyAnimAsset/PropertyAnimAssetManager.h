...
class WPropertyAnimAssetDocumentManager : public WAssetDocumentManager
{
  W_ADD_DYNAMIC_REFLECTION(WPropertyAnimAssetDocumentManager, WAssetDocumentManager);

public:
  WPropertyAnimAssetDocumentManager();
  ~WPropertyAnimAssetDocumentManager();
