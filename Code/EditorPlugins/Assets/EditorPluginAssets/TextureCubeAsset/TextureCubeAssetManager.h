...
class WTextureCubeAssetDocumentManager : public WAssetDocumentManager
{
  W_ADD_DYNAMIC_REFLECTION(WTextureCubeAssetDocumentManager, WAssetDocumentManager);

public:
  WTextureCubeAssetDocumentManager();
  ~WTextureCubeAssetDocumentManager();
