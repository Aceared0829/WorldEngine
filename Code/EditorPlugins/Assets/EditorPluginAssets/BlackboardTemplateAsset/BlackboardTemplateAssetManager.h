...
class WBlackboardTemplateAssetDocumentManager : public WAssetDocumentManager
{
  W_ADD_DYNAMIC_REFLECTION(WBlackboardTemplateAssetDocumentManager, WAssetDocumentManager);

public:
  WBlackboardTemplateAssetDocumentManager();
  ~WBlackboardTemplateAssetDocumentManager();
