...
class WMeshAssetDocumentManager : public WAssetDocumentManager
{
  W_ADD_DYNAMIC_REFLECTION(WMeshAssetDocumentManager, WAssetDocumentManager);

public:
  WMeshAssetDocumentManager();
  ~WMeshAssetDocumentManager();
