...
class WStateMachineAssetManager : public WAssetDocumentManager
{
  W_ADD_DYNAMIC_REFLECTION(WStateMachineAssetManager, WAssetDocumentManager);

public:
  WStateMachineAssetManager();
  ~WStateMachineAssetManager();
