...
class WColorGradientAssetDocumentManager : public WAssetDocumentManager
{
  W_ADD_DYNAMIC_REFLECTION(WColorGradientAssetDocumentManager, WAssetDocumentManager);

public:
  WColorGradientAssetDocumentManager();
  ~WColorGradientAssetDocumentManager();
