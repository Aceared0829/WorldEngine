...
class WAnimationClipAssetDocumentManager : public WAssetDocumentManager
{
  W_ADD_DYNAMIC_REFLECTION(WAnimationClipAssetDocumentManager, WAssetDocumentManager);

public:
  WAnimationClipAssetDocumentManager();
  ~WAnimationClipAssetDocumentManager();
