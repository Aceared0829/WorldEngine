...
class WProcGenGraphAssetDocumentManager : public WAssetDocumentManager
{
  W_ADD_DYNAMIC_REFLECTION(WProcGenGraphAssetDocumentManager, WAssetDocumentManager);

public:
  WProcGenGraphAssetDocumentManager();
  ~WProcGenGraphAssetDocumentManager();
