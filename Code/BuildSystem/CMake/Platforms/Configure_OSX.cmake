...
set_property(GLOBAL PROPERTY W_CMAKE_PLATFORM_OSX ON)
set_property(GLOBAL PROPERTY W_CMAKE_PLATFORM_POSIX ON)

macro(W_platform_pull_properties)

	get_property(W_CMAKE_PLATFORM_OSX GLOBAL PROPERTY W_CMAKE_PLATFORM_OSX)
...
macro(W_platform_detect_generator)
	if(CMAKE_GENERATOR MATCHES "Xcode") # XCODE
		message(STATUS "Buildsystem is Xcode (W_CMAKE_GENERATOR_XCODE)")

		set_property(GLOBAL PROPERTY W_CMAKE_GENERATOR_XCODE ON)
		set_property(GLOBAL PROPERTY W_CMAKE_GENERATOR_PREFIX "Xcode")
	...
	elseif(CMAKE_GENERATOR MATCHES "Ninja") # Ninja
		message(STATUS "Buildsystem is Ninja (W_CMAKE_GENERATOR_MAKE)")
		...
		message(FATAL_ERROR "Generator '${CMAKE_GENERATOR}' is not supported on OS X! Please extend W_platform_detect_generator()")
	endif()
endmacro()