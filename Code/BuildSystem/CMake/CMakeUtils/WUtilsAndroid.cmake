# #####################################
# ## W_list_subdirs(result curdir)
# #####################################

macro(W_list_subdirs result curdir)
...
# #####################################
# ## W_android_add_default_content(<target>)
# #####################################
function(W_android_add_default_content TARGET_NAME)
	W_pull_all_vars()

	if(NOT W_CMAKE_PLATFORM_ANDROID)
		return()
	endif()
	...
	set(CONTENT_DIRECTORY_SRC "${W_ROOT}/Data/Platform/Android")
	...
	W_list_subdirs(AVAILABLE_BUILD_TOOLS ${ANDROID_BUILD_TOOLS_ROOT})
