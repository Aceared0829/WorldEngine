# #####################################
# ## W_create_target_cs(<LIBRARY | APPLICATION> <target-name>)
# #####################################

macro(W_create_target_cs TYPE TARGET_NAME)
	W_apply_build_filter(${TARGET_NAME})

	set(ARG_OPTIONS NO_W_PREFIX)
	...
	if(ARG_UNPARSED_ARGUMENTS)
		message(FATAL_ERROR "W_create_target_cs: Invalid arguments '${ARG_UNPARSED_ARGUMENTS}'")
	endif()
	...
	elseif(${TYPE} STREQUAL "APPLICATION")
		...
		message(FATAL_ERROR "W_create_target_cs: Missing argument to specify target type. Pass in 'APPLICATION' or 'SHARED_LIBRARY' or 'STATIC_LIBRARY'.")
	endif()
	...
	# use W_make_windowapp if this is desired
