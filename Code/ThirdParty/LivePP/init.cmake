...
if(W_CMAKE_PLATFORM_WINDOWS_DESKTOP)
    set(W_3RDPARTY_LIVEPP_SUPPORT OFF CACHE BOOL "Enable Live++ support for Ez")
endif()

# #####################################
# ## W_requires_livepp()
# #####################################
macro(W_requires_livepp)
    W_requires(W_3RDPARTY_LIVEPP_SUPPORT)
endmacro()

function(W_export_directory TARGET_NAME)
    W_requires_livepp()
...
function(W_target_link_livepp TARGET_NAME)
    W_requires_livepp()
    ...
    W_export_directory(${TARGET_NAME})
endfunction()
