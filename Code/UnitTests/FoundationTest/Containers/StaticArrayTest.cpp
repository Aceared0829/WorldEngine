...
static_assert(sizeof(WStaticArray<WInt32, 1>) == 24);
#else
static_assert(sizeof(WStaticArray<WInt32, 1>) == 16);
#endif

static_assert(WGetTypeClass<WStaticArray<WInt32, 1>>::value == WTypeIsMemRelocatable::value);
static_assert(WGetTypeClass<WStaticArray<StaticArrayTestDetail::Dummy, 1>>::value == WTypeIsClass::value);

W_CREATE_SIMPLE_TEST(Containers, StaticArray)
{
  W_TEST_BLOCK(WTestBlock::Enabled, "Constructor")
  {
    WStaticArray<WInt32, 32> a1;
    WStaticArray<WConstructionCounter, 32> a2;
  ...
  W_TEST_BLOCK(WTestBlock::Enabled, "Copy Constructor")
  {
    ...
    WStaticArray<WInt32, 64> a2 = a1;
    WStaticArray<WInt32, 32> a3(a1);

    W_TEST_BOOL(a1.GetArrayPtr() == a2);
    W_TEST_BOOL(a1 == a3);
    W_TEST_BOOL(a2 == a3.GetArrayPtr());
  }

  W_TEST_BLOCK(WTestBlock::Enabled, "Convert to ArrayPtr")
  {
    WStaticArray<WInt32, 128> a1;
  ...
  W_TEST_BLOCK(WTestBlock::Enabled, "Index operator")
  {
    ...
    const WStaticArray<WInt32, 128> ca1 = a1;
  ...
  W_TEST_BLOCK(WTestBlock::Enabled, "SetCount / GetCount / IsEmpty")
  {
    ...
    for (WInt32 i = 0; i < 128; ++i)
    {
      ...
      W_TEST_INT((int)a1.GetCount(), i + 1);
      W_TEST_BOOL(!a1.IsEmpty());
    }
  ...
  {
    {
      ...
      WStaticArray<WConstructionCounter, 128> a1;
      WStaticArray<WConstructionCounter, 100> a2;
  ...
  {
    WStaticArray<StaticArrayTestDetail::Dummy, 128> list;
  ...
  {
    WStaticArray<StaticArrayTestDetail::Dummy, 32> list;
    list.PushBack(1);
    list.PushBack(2);
    list.PushBack(3);
    list.InsertAt(3, 4);
  ...
  W_TEST_BLOCK(WTestBlock::Enabled, "Assignment")
  {
    ...
    WStaticArray<StaticArrayTestDetail::Dummy, 32> list2;
    for (int i = 0; i < 8; i++)
    {
  ...
  W_TEST_BLOCK(WTestBlock::Enabled, "STL Iterator")
  {
    ...
    // const array
    const WStaticArray<WInt32, 1024>& a2 = a1;
