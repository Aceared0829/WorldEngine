#include <CppProjectGame/CppProjectGame.h>
...
W_APPLICATION_ENTRY_POINT(CppProjectGame);

CppProjectGame::CppProjectGame()
  : WGameApplication("CppProject", nullptr)
{
}

WResult CppProjectGame::TryProjectFolder(WStringView sPath)
{
...
void CppProjectGame::DetermineProjectPath()
{
  // IMPORTANT!
  //
  ...
  m_sAppProjectPath = "Data/Samples/CppProject";
}

WUniquePtr<WGameStateBase> CppProjectGame::CreateGameState()
{
...
WResult CppProjectGame::BeforeCoreSystemsStartup()
{
...
void CppProjectGame::AfterCoreSystemsStartup()
{
